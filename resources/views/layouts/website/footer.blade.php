...
<div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s">
    <div class="container py-5">
        <div class="row g-4 rounded mb-5" style="background: rgba(255, 255, 255, .03);">
            ...
            <p class="mb-2">{{ $settings->address ?? 'info@example.com' }}</p>
                    </div>
                </div>
            </div>
<div class="col-md-6 col-lg-6 col-xl-3">
    <div class="rounded p-4">
        ...
        <div>
            ...
            <p class="mb-2">{{ $settings->email ?? 'info@example.com' }}</p>
        </div>
    </div>
</div>
            <div class="col-md-6 col-lg-6 col-xl-3">
    ...
    <a href="tel:{{ $settings->website_link ?? '' }}" class="text-muted">{{ $settings->website_link ?? '(+012) 1234 567890' }}</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    <div class="footer-item">
                        ...
                        <p class="text-white mb-3">{{ $settings->description ?? 'info@example.com' }}</p>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
               ...
               <a href="{{ route('contact.contact') }}" class="nav-item nav-link {{ request()->is('contact') ? 'active' : '' }} me-2"><i class="fas fa-angle-right me-2"></i>Contact Us</a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="{{ $settings->facebook_link ?? 'info@example.com' }}" class=""><i class="fas fa-angle-right me-2"></i>facebook</a>
                    <a href="{{ $settings->instagram_link ?? 'info@example.com' }}" class=""><i class="fas fa-angle-right me-2"></i>instagram</a>
                    <a href="{{ $settings->twitter_link ?? 'info@example.com' }}" class=""><i class="fas fa-angle-right me-2"></i>twitter</a>
                    <a href="{{ $settings->youtube_link ?? 'info@example.com' }}" class=""><i class="fas fa-angle-right me-2"></i>youtube</a>
                    {{-- <a href="#" class=""><i class="fas fa-angle-right me-2"></i> Order History</a>
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>{{ $settings->website_name ?? 'Electro' }}</a>, All right reserved.</span>
            </div>
