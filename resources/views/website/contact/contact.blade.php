            ...
            <div class="p-5 bg-light rounded">
                <div class="row g-4">
                    ...
                    <div class="col-lg-7">
                        ...
                        <form action="{{ route('contact.contact.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control @error('project') is-invalid @enderror" 
                                               id="project" name="project" placeholder="Project" value="{{ old('project') }}">
                        ...
                        <div class="row g-4 align-items-center justify-content-center">
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="rounded p-4">
                                    ...
                                    <div>
                                        <h4>Address</h4>
                                        {{ $settings->address ?? 'info@example.com' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="rounded p-4">
                                    ...
                                    <div>
                                        <h4>Telephone</h4>
                                        {{ $settings->telephone ?? 'info@example.com' }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                                <div class="rounded p-4">
                                    ...
                                    <div>
                                        ...
                                        {{ $settings->website_link ?? 'info@example.com' }}
                                    </div>
                                </div>
                            </div>
                        </div>
